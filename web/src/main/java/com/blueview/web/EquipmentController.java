...
public class EquipmentController {
    ...
    @ResponseBody
    public List<Equipment> selectAll(@RequestParam(required = false) Equipment equipment) {
        List<Equipment> equipments = equipmentService.getEquipmentsSelective(equipment);
        return equipments;
    }
